...
## 🐳 Docker Quick Start
> **NEW!** Fully automated setup with Docker - models, datasets, and dependencies automatically downloaded!  
...
# Everything is automatically set up! Start training immediately:
...
> 🚀 **New!** For automated setup with Docker (including auto-download of models and tools), see [**SETUP.md**](./SETUP.md)
